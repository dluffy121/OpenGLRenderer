...
bool	ImGui_ImplOpenGL3_Init(ImGuiIO& ioShared)
{
	ImGuiIO& io = ImGui::GetIO();
	...
	// Setup backend capabilities flags
	io.BackendRendererUserData = ioShared.BackendRendererUserData;
	io.BackendRendererName = ioShared.BackendRendererName;
	io.BackendFlags = ioShared.BackendFlags;
