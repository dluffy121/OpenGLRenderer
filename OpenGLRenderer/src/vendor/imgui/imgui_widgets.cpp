...
bool ImGui::ColorEdit3(const char* label, core::Vec3& colVec3, ImGuiColorEditFlags flags)
{
	float col[3] { colVec3.x, colVec3.y, colVec3.z };
	bool changed = ColorEdit4(label, col, flags | ImGuiColorEditFlags_NoAlpha);
	if (changed)
	{
		colVec3.x = col[0];
		colVec3.y = col[1];
...
bool ImGui::ColorEdit4(const char* label, core::Vec4& colVec4, ImGuiColorEditFlags flags)
{
	float col[4] { colVec4.x, colVec4.y, colVec4.z, colVec4.w };
